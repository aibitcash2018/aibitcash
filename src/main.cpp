...
unsigned int nStakeMinAge = 1 * 24 * 60; // 1 days as zero time weight
unsigned int nStakeMaxAge = 60 * 24 * 60; // 60 days as full weight
...
const string strMessageMagic = "AibitCash Signed Message:\n";
...
// miner's coin base reward premine -- Premined: 5.000.000
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "AibitCash", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "AibitCash.com Block";
        CTransaction txNew;
        txNew.nTime = 1513750995;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1513750995;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2096322;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xc0aaa292d3b57e1fef1cc87424ad0e5f15d417e9e5918718f492e9b3fad0cb9d"));
        block.print();
